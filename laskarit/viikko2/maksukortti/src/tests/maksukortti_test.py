...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_onnistuu_kun_kortilla_rahaa_vain_edullisen_lounaan_verran(self):
        testikortti = Maksukortti(2.5)
        testikortti.syo_edullisesti()

        self.assertEqual(str(testikortti), "Kortilla on rahaa 0.0 euroa")

    def test_syo_maukkaasti_onnistuu_kun_kortilla_rahaa_vain_maukkaan_lounaan_verran(self):
        testikortti = Maksukortti(4)
        testikortti.syo_maukkaasti()

        self.assertEqual(str(testikortti), "Kortilla on rahaa 0 euroa")
